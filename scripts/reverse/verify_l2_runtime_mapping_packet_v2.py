...
children carrying one OS-derived Windows process creation FILETIME. Legacy v1
receipts remain useful for reacquisition/testing but cannot satisfy this gate.
"""
