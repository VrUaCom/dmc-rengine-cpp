...
int main() {
    ...
    assert(gap.registered_archives[0].resolution_rank == 0U);
    ...
    assert(later_gap.registered_archives[0].resolution_rank == 1U);
    assert(later_gap.registered_archives[1].resolution_rank == 0U);
