...
int main() {
    ...
    // This product representation is complete-or-invalid: if one of the six
    // evidenced prefix candidates cannot fit in the bounded 0x400-byte buffer,
    // it does not expose a partial sequence as a complete executable plan.
