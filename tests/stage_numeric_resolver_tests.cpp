...
int main() {
    ...
    // Synthetic fallback observation only; this does not assign gameplay
    // semantics to hundreds-family 5.
    ...
    // Canonical path rejects synthetic/non-authority bytes before any recovered
    // executable VAs can be interpreted.
