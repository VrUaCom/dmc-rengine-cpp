...
CharacterGenomeV0 builtin_profile(std::uint32_t i){
  CharacterGenomeV0 g{};
  if((i&1u)==0u){g.geometry={3200,19000,-9000,8500,-2200,1800,11000,1200,2300,0,5200,-1800}; g.skin={82,112,64,118,140,136,152,118,92,126,32,52}; g.eyes={42,34,25,78,54,31,118,112,64,0}; g.micro={146,170,48,0}; g.physiology={62,116,26,128}; g.identity_seed=0xA771E3D52C09ull; g.surface_seed=0xC0FFEE1234ull; g.eye_seed=0x123456789ABCull;}
  else {g.geometry={-1200,-6200,13100,1700,-1400,400,1200,4700,-900,-700,-2600,14200}; g.skin={104,126,72,86,154,148,132,92,70,98,58,48}; g.eyes={78,92,74,36,54,44,126,118,52,0}; g.micro={132,148,40,0}; g.physiology={64,122,22,128}; g.identity_seed=0xB55D001234ull; g.surface_seed=0xDEADBEEF42ull; g.eye_seed=0xCAFEBABE77ull;}
  return g;
}
}
