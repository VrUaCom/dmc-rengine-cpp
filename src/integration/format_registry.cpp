...
FormatIntegrationRegistry::FormatIntegrationRegistry() {
    formats_ = {
        ...
        FormatIntegrationDescriptor{
            ...
            .evidence_claim_ids = {},
            .limitations = {
                "Legacy compatibility identity only. DMC3 HD .afs/ strings are logical namespace prefixes; this descriptor does not authorize binary expansion.",
                "New classification uses afs-namespace or afs-binary-candidate so namespace evidence cannot silently become a container backend.",
            },
        },
        FormatIntegrationDescriptor{
            ...
            .evidence_claim_ids = {},
            .limitations = {
                "Logical DMC3-HD namespace identity, not a binary format descriptor.",
                "GData.afs/ and GDataX360.afs/ are resolved inside the recovered resource namespace; no second AFS decode stage is implied.",
            },
        },
        FormatIntegrationDescriptor{
            ...
            .evidence_claim_ids = {},
            .limitations = {
                "AFS-signature or generic .afs-file candidates are retained for acquisition only and are not expandable containers.",
                "No supported DMC3-HD raw binary AFS artifact, parser/backend xref or original-game consumption receipt is currently bound.",
            },
        },
        FormatIntegrationDescriptor{
            ...
            .limitations = {
                ...
                "Historical product-side PACK parsing is not original DMC3 runtime authority; structural promotion requires independent raw artifact and consumer evidence.",
            },
        },
        FormatIntegrationDescriptor{
            .format = "nbz",
