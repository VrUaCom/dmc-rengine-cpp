...
FormatIntegrationRegistry::FormatIntegrationRegistry() {
    formats_ = {
        ...
        FormatIntegrationDescriptor{
            ...
            .evidence_claim_ids = {},
            .limitations = {
                "Recognized at the recovered container dispatch handler (0x1402FE3B0).",
                "Shares the document shell structure with EFM and SCM: group/batch table, stream layout and continuation contract.",
                "Field semantics beyond geometry topology and full material/texture ownership remain evidence-gated.",
            },
        },
        FormatIntegrationDescriptor{
            .format = "dds",
        ...
        FormatIntegrationDescriptor{
            .format = "ptx",
            .parser_id = "formats.ptx-structural-v1",
            .maturity = IntegrationMaturity::structural,
            .write_policy = ResourceWritePolicy::read_only,
            .binary_adapter = false,
            .stage_category = gdspaces::StageResourceCategory::textures,
            .evidence_claim_ids = {},
            .limitations = {
                "No magic; recognized by the sector table closing exactly on the stored length and every declared block opening with a DDS image.",
                "A view over TextureSlotFramingParser, not a second parser: recognition and geometry both come from the one texture-pack authority.",
            },
        },
        FormatIntegrationDescriptor{
            .format = "cam",
        ...
        FormatIntegrationDescriptor{
            .format = "efm",
            .parser_id = "formats.efm-structural-v1",
            .maturity = IntegrationMaturity::structural,
            .write_policy = ResourceWritePolicy::read_only,
            .binary_adapter = false,
            ...
            .evidence_claim_ids = {},
            .limitations = {
                "Recognized at registry probe 0x1402DB1F0, container dispatch 0x1401B9FA0 and family mask 0x1402FD650, and at the container dispatch handler (0x1402F7A90).",
                "Shares the document shell structure with MOD and SCM: group/batch table, stream layout and continuation contract.",
                "Field semantics beyond geometry topology and full material/texture ownership remain evidence-gated.",
            },
        },
        FormatIntegrationDescriptor{
            ...
            .evidence_claim_ids = {},
            .limitations = {
                "That a `.mot` file is a motion is recovered from the animation registry; the track-chain layout below it is structural, corpus-derived from st001.pac slot 7 — no routine that reads it has been found in the image.",
                "Each track's declared size closes the chain to the terminator across every observed track, but only one track kind (3) has been observed.",
            },
        },
        FormatIntegrationDescriptor{
            .format = "shw",
            ...
            .evidence_claim_ids = {},
            .limitations = {
                "Recognized at registry probe 0x1402DB1F0, container dispatch 0x1401B9FA0 and family mask 0x1402FD650, and at the container dispatch handler (0x1403204C0).",
                "Breaks the MOD/EFM/SCM document-shell pattern: no groups, no batches, no +0x20 pointer, and a table that starts at +0x30 with four relocated pointers per entry.",
                "No corpus: the supplied data contains no SHW payload, so this is recovered and not corroborated.",
            },
        },
        FormatIntegrationDescriptor{
            .format = "mrp",
