...
FormatIntegrationRegistry::FormatIntegrationRegistry() {
    formats_ = {
        ...
        FormatIntegrationDescriptor{
            ...
            .evidence_claim_ids = {},
            .limitations = {
                "This descriptor is a logical DMC3-HD namespace identity, not a binary format descriptor.",
                "GData.afs/ and GDataX360.afs/ are resolved inside NBZ/ZIP or through the physical provider; no second AFS decode stage is implied.",
                "Namespace authoring is performed by writing the selected member path into a supported next-volume NBZ overlay.",
            },
            .source_adapter_id = {},
            .writer_modes = {},
        ...
        FormatIntegrationDescriptor{
            ...
            .evidence_claim_ids = {},
            .limitations = {
                "AFS-signature or .afs-file candidates are retained for acquisition only and are not expandable containers.",
                "No supported DMC3-HD raw binary AFS artifact, parser/backend xref, or game-consumption receipt is currently bound.",
                "A parser and writer must be promoted together with a profile-specific raw corpus and byte-exact round-trip receipts.",
            },
            .source_adapter_id = {},
            .writer_modes = {},
            .parser_validation_required = false,
        ...
        FormatIntegrationDescriptor{
            ...
            .evidence_claim_ids = {},
            .limitations = {
                "PACK-prefixed bytes are retained as acquisition candidates and are not expandable containers.",
                "The PACK parser in DMC 3 RENGINE (6).zip belongs to the Web DMC Rengine product and is not raw-corpus or original-runtime authority.",
                "Its unnamed header and entry fields must not be promoted into C++ authoring without an independently acquired real PACK artifact and consumer evidence.",
            },
            .source_adapter_id = {},
            .writer_modes = {},
            .parser_validation_required = false,
