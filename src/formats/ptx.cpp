...
[[nodiscard]] gdspaces::DiagnosticSeverity map_severity(
    ...
    switch (severity) {
    case ParseSeverity::info: return gdspaces::DiagnosticSeverity::info;
    case ParseSeverity::warning: return gdspaces::DiagnosticSeverity::warning;
    case ParseSeverity::error: return gdspaces::DiagnosticSeverity::error;
    }
...
gdspaces::ContainerExpansion Reader::expand_dds_children(
    ...
    auto expansion = profiles::dmc3::TextureSlotExpander::expand(parent, safety);
