...
The first wave deliberately covers practical language people are likely to use before they know DMC Rengine or the underlying format names: `DMC3 unpacker`, `Devil May Cry 3 extractor`, `DMC3 NBZ extractor`, `DMC3 model viewer`, `DMC3 texture extractor`, `open DMC3 MOD`, and `open DMC3 SCM`.
