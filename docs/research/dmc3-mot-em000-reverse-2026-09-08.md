...
**2026-09-09 follow-up:** quantization, signed track time offset, compression-3
interpolation and normal binding order now have executable evidence in
[dmc3-mot-key-evaluation-2026-09-09.md](dmc3-mot-key-evaluation-2026-09-09.md).
Candidate/unresolved labels below describe the earlier corpus-only checkpoint.
