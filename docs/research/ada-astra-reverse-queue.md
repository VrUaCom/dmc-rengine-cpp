...
Оновлено: 2026-09-15. Область: канонічний `dmc3.exe`, SHA-256
...
| Наступна | Матеріалізація `0x1403366E0` | Типи record fields, додатковий аргумент, успішні та всі помилкові шляхи; C++ і диференційні перевірки |
