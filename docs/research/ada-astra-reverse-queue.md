...
| Наступна | Placement `0x140331520` | Розміри й розміщення ділянок, причини відмови; замінити явну тестову межу |
| Відкрита | Palette helper `0x140331BD0` | Структура аргументу, лічильники, копіювання, результати AL |
