...
**Уточнення аудиту повноти:** [адресна перевірка пропусків](dmc3-tree-completeness-audit-2026-09-15.md) виявила 7450 підтверджених metadata-root targets, відсутніх у поточному CFG. Дерево залишається OPEN / NOT EXHAUSTIVE; 20 доменів не є доказом вичерпної структури.

Основу внутрішньої структури вже можна описати як граф: запуск і глобальна
ініціалізація; менеджери та фабрики сцен; модель об'єктів; ресурси; виконання
