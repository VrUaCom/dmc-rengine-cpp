# Format evidence, and how strong each piece is — pass of 2026-08-28

> This is **not** the format inventory. That is
> [the catalog](dmc3-hd-format-catalog.md) and
> [the registry](dmc3-hd-format-purpose-registry.json), which cover 66 families
> and are broader than this.
>
> This document is narrower and deeper: for the formats one reversing pass
> touched, what was read out of the executable, what was read off real files,
> and which of the two each claim rests on. Where the two disagree, the catalog
> is the inventory and this is the evidence behind a subset of it.
