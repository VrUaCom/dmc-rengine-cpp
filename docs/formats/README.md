...
- [Format evidence pass — 2026-08-28](dmc3-format-evidence-2026-08-28.md) — for the formats one reversing pass touched, which claims rest on the executable and which on real files.
