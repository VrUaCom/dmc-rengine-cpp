# Brand Voice and Marketing Guide

## Brand Character

DMC Rengine should sound:
...
DMC Rengine connects game resources, executable evidence, scene reconstruction, visual editing, safe patch planning, and long-term source recovery in one evidence-backed architecture.
...
- that full decompilation is complete;
- that a rebuilt executable already exists unless verified;
- that DMC Rengine contains or distributes game assets;
