...
public:
    ...
    // Full Wave-2 authority: reads both exact executable descriptor banks and
    // produces 189 deterministic entries while preserving source-bank/row
    // provenance. SHA and PE mapping are derived from the same byte span.
