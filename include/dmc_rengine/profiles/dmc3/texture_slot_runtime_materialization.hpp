...
[[nodiscard]] constexpr std::string_view to_string(
    ...
    case TextureSlotRuntimeMaterializationStatus::entry_out_of_bounds: return "entry-out-of-bounds";
    case TextureSlotRuntimeMaterializationStatus::entry_too_small: return "entry-too-small";
    case TextureSlotRuntimeMaterializationStatus::source_vtable_not_zero: return "source-vtable-not-zero";
    case TextureSlotRuntimeMaterializationStatus::descriptor_pointer_out_of_bounds: return "descriptor-pointer-out-of-bounds";
    case TextureSlotRuntimeMaterializationStatus::descriptor_truncated: return "descriptor-truncated";
    case TextureSlotRuntimeMaterializationStatus::dds_pointer_out_of_bounds: return "dds-pointer-out-of-bounds";
    case TextureSlotRuntimeMaterializationStatus::dds_range_out_of_bounds: return "dds-range-out-of-bounds";
    case TextureSlotRuntimeMaterializationStatus::dds_too_small: return "dds-too-small";
    case TextureSlotRuntimeMaterializationStatus::dds_magic_mismatch: return "dds-magic-mismatch";
    case TextureSlotRuntimeMaterializationStatus::dds_header_size_mismatch: return "dds-header-size-mismatch";
    case TextureSlotRuntimeMaterializationStatus::dds_pixel_format_size_mismatch: return "dds-pixel-format-size-mismatch";
    }
...
struct TextureSlotRuntimeMaterializationResult final {
    TextureSlotRuntimeMaterializationStatus status{TextureSlotRuntimeMaterializationStatus::entry_out_of_bounds};
