...
struct ContainerTreeExpansion final {
    ...
    // Identity expansions and actual parser calls are intentionally separate.
    // Alias slots may share one byte-domain parse while remaining distinct
    // graph/resource identities.
